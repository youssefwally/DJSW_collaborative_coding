...
## Description of your implementation choices.
Choose to follow mostly the tutorial on how to setup sphinx, as well as making it similarly
to how I do it in my Julia project.
