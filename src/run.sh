...
singularity exec -B ../../DJSW_env.sqsh:/user-software:image-src=/ ../../lumi-pytorch-rocm-6.2.4-python-3.12-pytorch-v2.7.1.sif python ./main.py --username waly --exp_name wmlp_train_1 --output_dir ../weights --train --num_epochs 100
